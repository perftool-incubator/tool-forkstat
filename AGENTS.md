...
- Python: post-processor (`forkstat-post-process.py`)
...
| `forkstat-post-process.py` | Converts raw forkstat output to crucible metrics |
...
- Runs as a profiler tool on master/worker roles, blocked on client and server
